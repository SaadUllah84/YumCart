    ...
    return Scaffold(
      ...
      AppBar(
        leading: GestureDetector(
            ...
            child: Icon(
              Icons.arrow_back_ios_new_outlined, color: Color(0xFF373866),)
        ),
        centerTitle: true,
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                "Upload the Item Picture", style: AppWidget.semiBoldTextField(),),
              SizedBox(height: 20,),
              selectedImage==null?
              GestureDetector(
                onTap: (){
              ...
              SizedBox(height: 30,),
              Text("Items Name", style: AppWidget.semiBoldTextField(),
              ),
              SizedBox(height: 10,),
              ...
              SizedBox(height: 30,),
              Text("Item Price", style: AppWidget.semiBoldTextField(),
              ),
              SizedBox(height: 10,),
              ...
              SizedBox(height: 30,),
              Text("Item Detail", style: AppWidget.semiBoldTextField(),
              ),
              SizedBox(height: 10,),
              Container(padding: EdgeInsets.symmetric(horizontal: 20),
                width: MediaQuery
              ...
              SizedBox(height: 20,),
              Text("Select Category",style: AppWidget.semiBoldTextField(),),
              SizedBox(height: 20,),
              Container(
                        ...
                        DropdownMenuItem<String>(
                          value: item,
                            child: Text(item, style: TextStyle(
                                fontSize: 18, color: Colors.black),))).toList(),
